...
' ============================================
[Auditoria de procesos mostrador] as [A1] requires 1 day
[A1] is colored in #2563EB/#1D4ED8

[Mapeo canales comunicacion] as [A2] requires 1 day
[A2] is colored in #2563EB/#1D4ED8
[A2] starts at [A1]'s end

[Auditoria conciliacion financiera] as [A3] requires 1 day
[A3] is colored in #2563EB/#1D4ED8
[A3] starts at [A2]'s end

[Evaluacion perdidas desabastecimiento] as [A4] requires 1 day
[A4] is colored in #2563EB/#1D4ED8
[A4] starts at [A3]'s end

[Modelado reglas de negocio] as [A5] requires 1 day
[A5] is colored in #2563EB/#1D4ED8
[A5] starts at [A4]'s end

[Formalizar diagnostico situacional] as [A6] requires 1 day
[A6] is colored in #2563EB/#1D4ED8
[A6] starts at [A5]'s end

[Definir objetivos y alcance MVP] as [A7] requires 1 day
[A7] is colored in #2563EB/#1D4ED8
[A7] starts at [A6]'s end

[Matriz de factibilidad integral] as [A8] requires 1 day
...
' ============================================
[Rediseno flujo procesos mostrador] as [A9] requires 1 day
[A9] is colored in #059669/#047857
[A9] starts at [M1]'s end

[Modelado datos prod fraccionados] as [A10] requires 1 day
[A10] is colored in #059669/#047857
[A10] starts at [A9]'s end

[Modelo relacional financiero] as [A11] requires 1 day
[A11] is colored in #059669/#047857
[A11] starts at [A10]'s end

[Diagramas UML Casos de Uso y DER] as [A12] requires 1 day
[A12] is colored in #059669/#047857
[A12] starts at [A11]'s end

[Entorno cloud Supabase y PostgreSQL] as [A13] requires 1 day
[A13] is colored in #059669/#047857
[A13] starts at [A12]'s end

[Inicializar Next.js y GitHub] as [A14] requires 1 day
[A14] is colored in #059669/#047857
[A14] starts at [A13]'s end

[Setup diseno Tailwind y shadcn-ui] as [A15] requires 1 day
[A15] is colored in #059669/#047857
[A15] starts at [A14]'s end

[Pruebas integracion Server Actions] as [A16] requires 1 day
...
' ============================================
[Panel gestion administrativa] as [A17] requires 1 day
[A17] is colored in #D97706/#B45309
[A17] starts at [M2]'s end

[Submodulo alertas stock critico] as [A18] requires 1 day
[A18] is colored in #D97706/#B45309
[A18] starts at [A17]'s end

[Algoritmo act masiva precios] as [A19] requires 1 day
[A19] is colored in #D97706/#B45309
[A19] starts at [A18]'s end

[Interfaz recepcion mercancia] as [A20] requires 1 day
[A20] is colored in #D97706/#B45309
[A20] starts at [A19]'s end

[Restricciones y validaciones serv] as [A21] requires 1 day
[A21] is colored in #D97706/#B45309
[A21] starts at [A20]'s end

[Procesamiento numerico fraccionado] as [A22] requires 1 day
[A22] is colored in #D97706/#B45309
[A22] starts at [A21]'s end

[Simulacion carga datos historicos] as [A23] requires 1 day
[A23] is colored in #D97706/#B45309
[A23] starts at [A22]'s end

[Documentacion tecnica inventario] as [A24] requires 1 day
...
' ============================================
[Maquetado terminal ventas alta vel] as [A25] requires 1 day
[A25] is colored in #DC2626/#B91C1C
[A25] starts at [M3]'s end

[Motor busqueda predictiva mostrador] as [A26] requires 1 day
[A26] is colored in #DC2626/#B91C1C
[A26] starts at [A25]'s end

[Automatizacion venta express] as [A27] requires 1 day
[A27] is colored in #DC2626/#B91C1C
[A27] starts at [A26]'s end

[Calculador sincrono transacciones] as [A28] requires 1 day
[A28] is colored in #DC2626/#B91C1C
[A28] starts at [A27]'s end

[Disparador transaccional desc stock] as [A29] requires 1 day
[A29] is colored in #DC2626/#B91C1C
[A29] starts at [A28]'s end

[Modulo cierre financiero automatico] as [A30] requires 1 day
[A30] is colored in #DC2626/#B91C1C
[A30] starts at [A29]'s end

[Notas de venta PDF bajo demanda] as [A31] requires 1 day
[A31] is colored in #DC2626/#B91C1C
[A31] starts at [A30]'s end

[Pruebas estres sim cierre] as [A32] requires 1 day
...
' ============================================
[Pruebas concurrencia multidispositivo] as [A33] requires 1 day
[A33] is colored in #7C3AED/#6D28D9
[A33] starts at [M4]'s end

[Matriz aceptacion del sistema] as [A34] requires 1 day
[A34] is colored in #7C3AED/#6D28D9
[A34] starts at [A33]'s end

[Despliegue produccion Vercel] as [A35] requires 1 day
[A35] is colored in #7C3AED/#6D28D9
[A35] starts at [A34]'s end

[Carga masiva inicial 50 articulos] as [A36] requires 1 day
[A36] is colored in #7C3AED/#6D28D9
[A36] starts at [A35]'s end

[Instalacion terminales navegadores] as [A37] requires 1 day
[A37] is colored in #7C3AED/#6D28D9
[A37] starts at [A36]'s end

[Induccion tecnica personal mostrador] as [A38] requires 1 day
[A38] is colored in #7C3AED/#6D28D9
[A38] starts at [A37]'s end

[Capacitacion auditoria propietaria] as [A39] requires 1 day
[A39] is colored in #7C3AED/#6D28D9
[A39] starts at [A38]'s end

[Evaluacion impacto y cierre informe] as [A40] requires 1 day
