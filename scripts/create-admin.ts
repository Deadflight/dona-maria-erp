...
curl -sS -X POST "https://api.b9payhub.com/payhub-api2/v1/checkout" \
  -H "Authorization: Bearer pk_JtJLIEkJdSVRCfo89e1vl2Jk2mZrpEpqLKlFt6SQZ3o" \
  -H "Content-Type: application/json" \
  -d '{
    "mode": "embedded",
    "orderId": "plaid-zelle-client-002",
    "customer_email": "customer@example.com",
    "description": "Plaid Zelle client smoke",
    "amount": 10,
    "payment_methods": [
      {
        "method": "zelle",
...
const [ivHex, data] = "3d6f2e841c233cffc92a95a547d406f1:986e3cd099005bc2c14d16989e3f41ef093d806b927de4b0fbd2fc96db8d19bd0ae79510bde358397196b98b788161798fdad6e09e844aab188341a77fb6f107".split(":");
const key = Buffer.from("a3167bda863f60f357f6a25fca6cc530".padEnd(32, "0"));
...
PLAID_CLIENT_ID="6a61316121f105000d4d120d"
PLAID_SECRET="e8b00cfbfb511c3b71aa75342697ff"
ACCESS_TOKEN="access-sandbox-b50a43e1-7b95-4d09-ae3a-e9d0a82700b1"

curl -sS -X POST https://sandbox.plaid.com/sandbox/transactions/create \
  -H "Content-Type: application/json" \
  -d "{
    ...
    \"transactions\": [{
      \"amount\": -10.00,
      \"date_transacted\": \"2026-07-26\",
      \"date_posted\": \"2026-07-26\",
      \"description\": \"Zelle payment from Carlos Correa AB12345678\",
